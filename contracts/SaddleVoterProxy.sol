...
abstract contract SaddleVoterProxy is BaseStrategy {
    ...
    address public constant voter = address(0x882094c153D83DA48Df9660e7470a478199f1bd5); // TODO change to slpVoter
    ...
    constructor(address _vault) BaseStrategy(_vault) {
        ...
        profitFactor = 1000;
        debtThreshold = 1e24;
        proxy = address(0x9a165622a744C20E3B2CB443AeD98110a33a231b); // TODO: change to strategy proxy
    }
